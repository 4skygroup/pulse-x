    ...
    return (
        <section className="w-full bg-black px-8 py-20 flex flex-col gap-12">
            <div className="flex flex-col gap-6 max-w-5xl mx-auto w-full">
                <h2 className="font-glacial font-bold text-t3 md:text-h6 text-white tracking-widest uppercase text-center">
                    {title}
                </h2>
                <p className="font-glacial text-t5 md:text-t4 text-pulse-x-subtitle-gray leading-relaxed max-w-5xl">
                    {subtitle}
                </p>
            </div>
